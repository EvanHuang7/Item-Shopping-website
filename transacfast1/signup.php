...
<div class="container mt-3">
	<form action="backendScript/signup_process.php" method="POST">
	  <h3>Sign Up</h3>
	  <div class="form-group">
	  	<?php
	  		if ( isset($_GET['first']) ) {
	  			$first = $_GET['first'];
	  			echo '<input type="text" class= "form-control" name="first" placeholder="Firstname" value='.$first.'>';
	  		}
	  		else{
	  			echo '<input type="text" class= "form-control" name="first" placeholder="Firstname">';
	  		}
	  	?>
	  </div>
	  ...
	  <div class="form-group">
	  	<?php
	  		if ( isset($_GET['last']) ) {
	  			$last = $_GET['last'];
	  			echo '<input type="text" class= "form-control" name="last" placeholder="Lastname" value='.$last.'>';
	  		}
	  		else{
	  			echo '<input type="text" class= "form-control" name="last" placeholder="Lastname">';
	  		}
	  	?>
	  </div>
